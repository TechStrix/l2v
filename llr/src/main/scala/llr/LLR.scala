...
//  val inputFile = "/Users/jaimealmeida/capstone/data/sectioned/134816-966222"
  val inputFile = "/Users/jaimealmeida/capstone/data/toytest.txt"
  def main(args: Array[String]) {
    userSimilarites(
      "master",
       ...
       2,
       100,
       500, // max number of interactions per user
       12345)
  }
...
//    val  rawInteractions_set =rawInteractions_data.map { line =>
    val  rawInteractions_set =rawInteractions.map { line =>
  ...
  similarities.repartition(1).saveAsTextFile("./src/main/resources/toytest2");
  sc.stop()
}
